...
contract FactoryTest is Test {
    ...
    function test_marketCreation() public {
        ...
        bytes32 conditionId =
            factory.createPredictionMarket(initialLiquidity, tokenInQuestion, 0, collateralToken, marketParams, pool);
        ...
        console2.log("The current price of the asset is:", truthModule.getPrice(IUniswapV3Pool(pool)));
